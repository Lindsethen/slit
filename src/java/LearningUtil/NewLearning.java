...
public class NewLearning {
    ...
    public void newLearning(int gId, String gName, String gDesc, PrintWriter out){
        String strInsert = "Insert into goals (g_id, g_name,  g_string) values ('" +gId + "', '" +gName + "', '" +gDesc  +"')";
