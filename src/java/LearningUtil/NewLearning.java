...
public class NewLearning {
    ...
    public void newLearning(int g_ID, String lg_name, String lg_string, PrintWriter out){
        String strInsert = "Insert into goals (lg_id, lg_name,  lg_string) values ('" +g_ID + "', '" +lg_name + "', '" +lg_string +"')";
